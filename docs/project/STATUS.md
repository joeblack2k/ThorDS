...
| M10 | PARTIAL | e6f1da7e | docs/evidence/m10/ | guarded native/JNI config and 100% telemetry are wired and sampled on Thor; equivalence, drift and over-100 runtime gates remain open |
