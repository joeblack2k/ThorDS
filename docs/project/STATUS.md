...
| M11 | PARTIAL | pending | docs/evidence/m11/ | ROM-details resolved ThorDS profile status plus per-ROM Original/Enhanced and RA mode controls compile and smoke green; relaunch staging and full physical details-flow acceptance remain open |
