...
| M11 | PARTIAL | 760f3c2b | docs/evidence/m11/ | ROM-details resolved ThorDS profile status, per-ROM Original/Enhanced and RA controls, and physical pre-launch Enhanced+Hardcore recovery choices pass; Original+restart selection and full physical details-flow acceptance remain open |
