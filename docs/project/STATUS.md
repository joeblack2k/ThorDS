...
| M10 | PARTIAL | e5542fb8 | docs/evidence/m10/ | guarded native/JNI config, persisted preference fail-closed check, 100% telemetry and a 10-minute 100% stability slice are green; equivalence, drift and formal over-100 runtime gates remain open |
